...
[**[All](#functions)**] - [[`open()`](#open)] - [[`lookup()`](#lookup)] - [[`lookup_async()`](#lookup_async)] - [[`pending_lookup_wait()`](#pending_lookup_wait)] - [[`insert()`](#insert)] - [[`insert_async()`](#insert_async)] - [[`pending_insert_wait()`](#pending_insert_wait)] - [[`delete_async()`](#delete_async)] - [[`pending_delete_wait()`](#pending_delete_wait)]
...
* **`store`**: _[`object_store_handle`](#object_store_handle)_
* **`key`**: `string`
* **`pending_handle_out`**: _[`pending_kv_lookup_handle`](#pending_kv_lookup_handle)_ mutable pointer
...
* **`pending_objstr_handle`**: _[`pending_kv_lookup_handle`](#pending_kv_lookup_handle)_
* **`body_handle_out`**: _[`body_handle`](#body_handle)_ mutable pointer
...
* **`key`**: `string`
* **`body_handle`**: _[`body_handle`](#body_handle)_
* **`pending_handle_out`**: _[`pending_kv_insert_handle`](#pending_kv_insert_handle)_ mutable pointer
...
* **`pending_objstr_handle`**: _[`pending_kv_insert_handle`](#pending_kv_insert_handle)_
...
* **`store`**: _[`object_store_handle`](#object_store_handle)_
* **`key`**: `string`
* **`pending_handle_out`**: _[`pending_kv_delete_handle`](#pending_kv_delete_handle)_ mutable pointer
...
* **`pending_objstr_handle`**: _[`pending_kv_delete_handle`](#pending_kv_delete_handle)_
